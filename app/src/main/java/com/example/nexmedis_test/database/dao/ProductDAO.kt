...
"""
    ...
    fun getAllProductWithFavouriteModifier(query: String = ""): PagingSource<Int, ProductWithFavouriteEntity>
    ...
    FROM products
    LEFT JOIN productFavourites ON products.id = productFavourites.productId
    WHERE productFavourites.productId IS NOT NULL AND products.title LIKE '%' || :query || '%' 
    ORDER BY products.id ASC
"""
    )
    fun getAllProductFavourite(query: String = ""): PagingSource<Int, ProductWithFavouriteEntity>
